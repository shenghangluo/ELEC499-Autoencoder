...
class Encoder(object):
    def __init__(self, inputs, n_layers, n_neurons, activation, latent_size, name='encoder'):
        with tf.name_scope(name):
            ...
            second_dense_1 = tf.layers.dense(inputs=first_dense_1, units=latent_size, activation=None, name='encoder_dense_2')    # shape (?, 1, 8)
            #second_dense_1 = tf.layers.dense(inputs=second_dense_1, units=latent_size, activation=None, name='encoder_dense_3')
            ...
            second_dense_2 = tf.layers.dense(inputs=first_dense_2, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_2 = tf.layers.dense(inputs=second_dense_2, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_3 = tf.layers.dense(inputs=input_3, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_3 = tf.layers.dense(inputs=first_dense_3, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_3 = tf.layers.dense(inputs=second_dense_3, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_4 = tf.layers.dense(inputs=input_4, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_4 = tf.layers.dense(inputs=first_dense_4, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_4 = tf.layers.dense(inputs=second_dense_4, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_5 = tf.layers.dense(inputs=input_5, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_5 = tf.layers.dense(inputs=first_dense_5, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_5 = tf.layers.dense(inputs=second_dense_5, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_6 = tf.layers.dense(inputs=input_6, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_6 = tf.layers.dense(inputs=first_dense_6, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_6 = tf.layers.dense(inputs=second_dense_6, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_7 = tf.layers.dense(inputs=input_7, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_7 = tf.layers.dense(inputs=first_dense_7, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_7 = tf.layers.dense(inputs=second_dense_7, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_8 = tf.layers.dense(inputs=input_8, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_8 = tf.layers.dense(inputs=first_dense_8, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_8 = tf.layers.dense(inputs=second_dense_8, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_9 = tf.layers.dense(inputs=input_9, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_9 = tf.layers.dense(inputs=first_dense_9, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_9 = tf.layers.dense(inputs=second_dense_9, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_10 = tf.layers.dense(inputs=input_10, units=n_neurons, activation=activation,
                                            name='encoder_dense_1', reuse=True)
            second_dense_10 = tf.layers.dense(inputs=first_dense_10, units=latent_size, activation=None,
                                             name='encoder_dense_2', reuse=True)
            # second_dense_10 = tf.layers.dense(inputs=second_dense_10, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_11 = tf.layers.dense(inputs=input_11, units=n_neurons, activation=activation,
                                             name='encoder_dense_1', reuse=True)
            second_dense_11 = tf.layers.dense(inputs=first_dense_11, units=latent_size, activation=None,
                                              name='encoder_dense_2', reuse=True)
            # second_dense_11 = tf.layers.dense(inputs=second_dense_11, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_12 = tf.layers.dense(inputs=input_12, units=n_neurons, activation=activation,
                                             name='encoder_dense_1', reuse=True)
            second_dense_12 = tf.layers.dense(inputs=first_dense_12, units=latent_size, activation=None,
                                              name='encoder_dense_2', reuse=True)
            # second_dense_12 = tf.layers.dense(inputs=second_dense_12, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            first_dense_13 = tf.layers.dense(inputs=input_13, units=n_neurons, activation=activation,
                                             name='encoder_dense_1', reuse=True)
            second_dense_13 = tf.layers.dense(inputs=first_dense_13, units=latent_size, activation=None,
                                              name='encoder_dense_2', reuse=True)
            # second_dense_13 = tf.layers.dense(inputs=second_dense_13, units=latent_size, activation=None,
            #                                  name='encoder_dense_3', reuse=True)
            ...
            power2 = tf.math.sqrt(tf.reduce_sum(power1, axis=2, keepdims=True))
            ...
            # Max energy
            power = tf.math.abs(self._complex)
            max_power = tf.keras.backend.max(power, axis=2, keepdims=True)

            real = tf.math.real(self._complex)
            imag = tf.math.imag(self._complex)
            max_power = max_power + 1e-8

            real = tf.math.divide(real, max_power)
            imag = tf.math.divide(imag, max_power)
            ...
            self._real_central = tf.reshape(self._real, [-1, 52])
            self._real_central = tf.slice(self._real_central, [0, 4*6], [-1, 4])

            self._image_central = tf.reshape(self._image, [-1, 52])
            self._image_central = tf.slice(self._image_central, [0, 4*6], [-1, 4])

            self._central = tf.concat([self._real_central, self._image_central], 1)
            print("self._central shape is: ", self._central.shape)
