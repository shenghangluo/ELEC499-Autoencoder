...
class Trainer(object):
    ...
    def train_model(self):
        ...
        with tf.Session() as sess:
            ...
            #saver = tf.train.import_meta_graph('C:/ELEC 499/Try/ML-research-0.meta')
            #saver.restore(sess, tf.train.latest_checkpoint('C:/ELEC 499/Try'))
            #new_saver = tf.train.import_meta_graph('C:/ELEC 499/Try/ML-research-0.meta')
