...
TRAIN_MESS = 80000  # around 8,0000
VALID_MESS = 10000
TEST_MESS = 50000
group_num = 13
...
class Trainer(object):
    ...
    def train_model(self):
        ...
        with tf.Session() as sess:
            ...
            #new_saver = tf.train.import_meta_graph('C:/ELEC 499/code-0224-59.meta')
            #new_saver.restore(sess, 'C:/ELEC 499/code-0224-59')
            for epoch in range(0, self._n_epochs):
                ...
                if epoch <= 20:
                    for X_batch, y_batch in self._dataset.shuffle_batch(data['X_train'], data['y_train'], self._batch_size):
                        ...
                        #print("self._model.get_reconstruction() is: ", self._model.get_reconstruction().eval(feed_dict={self._model.X: X_batch, self._model.Noise: 0.366}))
